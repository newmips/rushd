...
var privateKey = fs.readFileSync("/etc/ssl/cacerts/server.key", 'utf8');
var certificate = fs.readFileSync("/etc/ssl/cacerts/server.crt", 'utf8');
...
var serverIpAddress = process.env.OPENSHIFT_NODEJS_IP || '192.168.1.161'//'localhost'
var socketIoServer = '192.168.1.161';// '127.0.0.1';
...
var server=https.createServer({
  key: fs.readFileSync("/etc/ssl/cacerts/server.key", 'utf8'),
  cert: fs.readFileSync("/etc/ssl/cacerts/server.crt", 'utf8')
}, app)
